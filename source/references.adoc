...
link:http://www.ibm.com/developerworks/library/l-rpm1/[Packaging software with RPM, Part 1], http://www.ibm.com/developerworks/library/l-rpm2/[Part 2], http://www.ibm.com/developerworks/library/l-rpm3/[Part 3] - IBM RPM packaging guide.
