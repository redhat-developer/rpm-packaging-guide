...
You can use RPM Conditionals to express any condition in the SPEC file. RPM Conditionals are the tags that enable the conditional inclusion of various sections of the SPEC file.

Most commonly, conditionl inclusion deals with: 

* architecture-specific sections
* operating system-specific sections
* resolves compatibility issues between various versions of operating systems
* others 
* others
