...
This conditional handles definition of the macros. If the %milestone or ​the %revision macros are set, the %development_release macro is defined and the %ruby_archive macro, which defines the name of the upstream tarball, is redefined.
