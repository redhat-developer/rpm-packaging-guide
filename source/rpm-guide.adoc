...
<<general-background.adoc#preparing-software-for-packaging>>:
...
release in the <<general-background.adoc#preparing-software-for-packaging>>
...
code we downloaded (or we created in the <<general-background.adoc#preparing-software-for-packaging>> section).
...
software. For those who read the <<general-background.adoc#preparing-software-for-packaging>> section, this portion of the example should look familiar.
