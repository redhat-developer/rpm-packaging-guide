...
* How to package source code into an RPM. This is for software developers who need to package software into RPMs. See <<rpm-guide.adoc#packaging-software>>.
...
<<rpm-guide.adoc#packaging-software>> is a tutorial that guides through basic
