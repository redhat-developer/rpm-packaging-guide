...
* How to prepare source code for packaging into an RPM. This is for people with no background in software development. See <<general-background.adoc#preparing-software-for-packaging>>.
...
The <<general-background.adoc#preparing-software-for-packaging>> is a tutorial that
