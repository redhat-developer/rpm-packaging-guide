...
NOTE: In order to use https://github.com/rpm-software-management/mock/wiki[Mock] on a RHEL or CentOS system, you will need to enable
...
One of the most common use cases RPM Packagers have for https://github.com/rpm-software-management/mock/wiki[Mock] is to create
...
https://github.com/rpm-software-management/mock/wiki[Mock] solves this by first parsing the contents of the SRPM and installing the
...
With https://github.com/rpm-software-management/mock/wiki[Mock], you don’t have to install ``gcc`` on your system because it will
...
that is our next section’s subject, https://github.com/release-engineering/dist-git[dist-git]. Since this project is publicly hosted on https://github.com/[GitHub], let’s go ahead and clone the git
repo.
...
section, however an exhaustive list can be found at the http://rpm.org/user_doc/macros.html[RPM Official Documentation].
...
One primary example of this is the https://docs.fedoraproject.org/en-US/packaging-guidelines/[Fedora Packaging Guidelines] section
pertaining specifically to https://docs.fedoraproject.org/en-US/packaging-guidelines/#_domain_specific_guidelines[Application Specific Guidelines] which at the time
