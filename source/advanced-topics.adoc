...
----
+
Under this line insert following code:
+
[source,specfile]
----
...
[source,bash]
----
# dnf install ~/rpmbuild/RPMS/noarch/pello-0.1.1-1.fc27.noarch.rpm
----
+
...
Write a line `%post -p /usr/bin/python3` under the line `install{nbsp}-m` in a SPEC file.
